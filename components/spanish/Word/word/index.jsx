      ...
      {score < 4 && (
        <div className="relative">
          ...
          <div
            ...
            className="absolute left-0 top-0 bg-white cursor-pointer hover:p-1 hover:duration-100"
          >
            <LocalHospitalIcon />
            <EditIcon onClick={clickTrash} />
          </div>
          <div className={`  absolute right-1 top-1 bg-white`}>
            {word.count}
          </div>
        </div>
      )}
