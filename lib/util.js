...
export const addMiddle = (arr, item) => {
  // Calculate the middle index
  const middleIndex = Math.floor(arr.length / 2)

  // Use splice to add the item at the middle index
  arr.splice(middleIndex, 0, item)

  return arr
}
export const getRandInd = (lim) => {
...
export const localsStorageItems = {
  photoURL: "photoURL",
